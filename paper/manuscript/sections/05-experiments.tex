...
\paragraph{External evaluation protocol.}
We prepared fixture-tested, phase-separated adapters and preregistrations for
LongMemEval-S cleaned and LoCoMo question answering. Generation cannot open
Gold, and formal execution requires a custodian authorization bound to exact
dataset, product, adapter, and preregistration hashes. This paper asset
preparation did not execute either formal held-out benchmark.
