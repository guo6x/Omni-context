// Omni-Context Agent Skill 内容（与 skills/omni-context-memory/SKILL.md 同步）。
// 供设置面板「复制 Skill」一键复制，用户粘到 Claude/Claude Code 的 skills 目录。

export const OMNI_SKILL_FILENAME = 'omni-context-memory/SKILL.md';

export const OMNI_SKILL_CONTENT = `---
