# Validation 120 Contract Audit (regression-tests-run)

**Overall:** PASS · **Samples:** 120 (15 task types × 8)

| Dimension | PASS | FAIL | AMBIGUOUS |
|---|---|---|---|
| authority_action | 120 | 0 | 0 |
| deleted_source_provenance | 120 | 0 | 0 |
| action_eligibility | 120 | 0 | 0 |
