    ...
    for (let attempt = 0; attempt <= config.max_retries; attempt++) {
      ...
      try {
        ...
        const record = {
          ...
          primary_judge_temperature_control: config.primary_judge.temperature_control,
          primary_judge_temperature_parameter_sent: config.primary_judge.temperature_parameter_sent,
          ...
          answer_schema_validation_attempts: answerResult.schema_validation_attempts || 1,
          answer_schema_normalizations: answerResult.schema_normalizations || [],
          raw_judge_response: judgeResult?.raw || null,
          structured_judge: judgeResult?.structured || null,
          judge_model: judgeResult?.model || null,
          logical_judge_call: judgeResult?.logical_judge_call || null,
          physical_judge_attempts: judgeResult?.physical_attempts || 0,
          judge_retry_recovered: judgeResult?.retries_recovered || false,
          ...
          usage: {
            ...
            judge_physical_attempts: judgeResult?.physical_attempts || 0,
